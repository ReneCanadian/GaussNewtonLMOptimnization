function [info, tab_val_f, f_val_min, reg_min, time, iterations ,magnitude_difference, calculated_parameters_ret] = gs_RunWithNoiseDataWithRegul(noise_data, data,init_parameters,t, true_parameters, regul)
